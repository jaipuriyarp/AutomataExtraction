...
from groundTruthFunctions import Lang_is_aStarbStaraStarbStar
from checkEquivalence import CheckEquivalence
from recordTime import RecordTime

RNNModelName = "modelRNNQ_lang7_aStarbStaraStarbStarSeq.pt"
RNNModelPath = os.path.join(modelDir, "models", RNNModelName)

rnnInterface = RNNInterface(rnn_model_path=RNNModelPath, input_size=1)
gTComparison = GTComparison(Lang_is_aStarbStaraStarbStar)
checkEquivalence = CheckEquivalence(depth=10, num_of_RationalNumber=3,
